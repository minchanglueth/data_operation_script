...
# client_slack = WebClient(token='xoxb-1216139827667-1906835181267-DJ8Y1MyqU1UlJxSVXBRYr6xI') # slack ở bên M<3 cũ
client_slack = WebClient(token='xoxb-3598555470-1887074714135-mOnbmqkIhyZUPwz0hxuGuiq2') # slack ở VIBBIDI
# client_slack = WebClient(token='xoxb-3598555470-1887074714135-mtHVkOQia1xZXqI7QEt8yQWs') # slack ở VIBBIDI cũ
